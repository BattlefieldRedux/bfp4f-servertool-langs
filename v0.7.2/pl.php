...
$lang = array(
	...
	'msg_limdis' => '<b>UWAGA</b> Wszystkie limitery zostały wyłączone!',
	'msg_igcmdsdis' => '<b>UWAGA</b> Wszystkie komendy z gry zostały wyłączone',
	'msg_minusone' => 'Widziałeś watcher Twojego serwera? Sprawdź <a href="../public" class="alert-link">tutaj</a>, ale najpierw włącz tą opcję w ustawieniach!',
	...
	// i3D API
	'i3d' => 'i3D API',
	'i3d_your' => 'Twój server i3D.net',
	'i3d_start' => 'Start server',
	'i3d_stop' => 'Stop server',
	'i3d_restart' => 'Restart server',
	'i3d_cpu' => 'Użycie CPU',
	'i3d_mem' => 'Użycie RAMu',
	'i3d_disk' => 'Zużycie dysku',
	'i3d_warn1' => '<b>UWAGA</b> opcja możliwa jedynie dla serwerów i3D.net!',
	'i3d_err1' => 'i3D API: Server nie został znaleziony - złe server ID',
	'i3d_err2' => 'Ta opcja jest możliwa jedynie dla serwerów i3D.net lub podałeś złe dane!',
	'i3d_msg1' => 'Trwa włączanie serwera...',
	'i3d_msg2' => 'Trwa wyłączanie serwera...',
	'i3d_msg3' => 'Trwa restart serwera...',
	...
	'tool_server_switchmap' => 'Przełącz mapę',
	'tool_server_switchmap_msg' => 'Przełączono mapę na %map%',
	...
	'tool_server_closepoll' => 'Zamknij aktualne głosowanie',
	'tool_server_closepoll_msg' => 'Głosowanie zostało zamknięte',
	'tool_server_closepoll_err' => 'Żadne głosowanie nie odbywa się w tej chwili',
	...
	'tool_server_switchpl_msg' => 'Team gracza został zmieniony',
	'tool_server_ranked' => 'RANKINGOWY', // NOTE: All uppercase!
	'tool_server_unranked' => 'NIE RANKINGOWY', // NOTE: All uppercase!
	'tool_server_joining' => 'wczytuje się', // NOTE: All lowercase
	...
	'tool_server_loadout' => 'Sprawdź loadout',
	'tool_server_loadout_title' => 'Loadout gracza', // Loadout of {name}
	
	// Server settings
	'tool_svset' => 'Opcje serwera',
	'tool_svset_desc' => 'Ustawienia Twoje serwera',
	...
	'tool_igcmds_votes' => 'Potrzebnych głosów',
	'tool_igcmds_active' => 'Komenda w grze aktywna',
	'tool_igcmds_pt_opt' => 'Zamyka głosowanie po %s% sekundach',
	'tool_igcmds_polltime' => 'Czas głosowania',	
	...
	'tool_igcmds_err6' => 'Coś ty wpisał w ilośc głosów? Sprawdź to!',
	'tool_igcmds_err7' => 'Coś ty wpisał w czas głosowania? Sprawdź to!',
	'tool_igcmds_help1' => 'Poziom praw między 0 - 100',
	'tool_igcmds_help2' => 'cmdMessage, cmdKickPlayer, cmdWarnPlayer, cmdBanPlayer oraz cmdFunnyWord',
	'tool_igcmds_help3' => 'Odpowiedź wysyłana tylko do gracza?',
	'tool_igcmds_help4' => 'Komenda aktywna?',
	
	'tool_tmsg' => 'Wiadomości czasowe',
	'tool_tmsg_add' => 'Dodaj czasową wiadomość',
	'tool_tmsg_edit' => 'Edytuj czasową wiadomość',
	'tool_tmsg_desc' => 'Pokazuj czasowe wiadomości na serwerze',
	'tool_tmsg_msg' => 'Wiadomość',
	'tool_tmsg_freq' => 'Częstotliwość',
	'tool_tmsg_active' => 'Włączone?',
	'tool_tmsg_secs' => 'sekund',
	'tool_tmsg_deleted' => 'Wiadomość czasowa została usunięta',
	'tool_tmsg_opt' => 'Pokazuj co %s% sekund',
	'tool_tmsg_err1' => 'Nie znaleziono wiadomości czasowych',
	'tool_tmsg_err2' => 'Wiadomość jest za długa - max. 150 znaków',
	'tool_tmsg_err3' => 'Niepoprawna częstotliwość',
	'tool_tmsg_help1' => 'Wiadomość aktywna?',
	...
	'tool_logs_autokick_desc' => 'Wszystkie wykonane kicki',
	'tool_logs_cp_actions' => 'Log panelu kontrolnego',
	'tool_logs_cp_actions_desc' => 'Wszystkie wykonane akcje z panelu',
	'tool_logs_igcmds' => 'Log IGA',
	'tool_logs_igcmds_desc' => 'Wszystkie wykonane komendy',
	'tool_word_desc' => 'Opis',
	'tool_logs_info1' => 'Brak wpisów w logu',
	'tool_logs_err1' => 'Nie znaleziono logu',
	...
	'tool_ping' => 'Ping',
	'tool_ping_desc' => 'Sprawdza status połączenia',
	'tool_ping_info1' => 'Ping pomiędzy servertool-em a serwerem gry:',
	'tool_ping_info2' => 'Pomiędzy serwerem gry a servertool-em',
	'tool_ping_info3' => 'Ping pomiędzy servertoolem i stroną BFP4F wynosi:',
	'tool_ping_status1' => 'Połączenie jest zajebiste!',
	'tool_ping_status2' => 'Połączenie jest średnie',
	'tool_ping_status3' => 'Połaczenie jest lipne!',
	
	'tool_watcher' => 'Publiczny watcher',
	
	'tool_minusone' => 'Kicker za level -1',
